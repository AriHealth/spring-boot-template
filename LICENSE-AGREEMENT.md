This End-User License Agreement (the *EULA*) is a legal agreement between the *Licensee*, an individual, and Atos Spain S.A. Unipersonal (the *Company*), the author of **Spring Template** (the *Software*), which may include associated media, printed materials, and *online* or electronic documentation.
...
- *Software* shall mean **Spring Template** (optional) the deliverables provided pursuant to this *EULA*.
2.	**Grant of License**
